...
void cgeGetDataAndChannelByFormat(CGEBufferFormat fmt, GLenum *dataFmt, GLenum *channelFmt,
                                  GLint *channel);

#ifdef __cplusplus
const char *cgeGetBlendModeName(const CGETextureBlendMode mode, bool withChinese = false);
GLuint
cgeGenTextureWithBuffer(const void *bufferData, GLint w, GLint h, GLenum channelFmt, GLenum dataFmt,

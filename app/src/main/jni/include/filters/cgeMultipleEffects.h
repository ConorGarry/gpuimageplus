...
namespace CGE {
    ...
    // This class is inherited from top filter interface and would do more processing steps than "CGEImageFilter" does.
    ...
    public:
        ...
        bool initWithEffectString(CGEImageHandlerAndroid *handler, const char *pstr);
        ...
        int getFilterSize() { return m_vecFilters.size(); }

        CGEImageFilterInterface *getFilter() { return m_vecFilters[0]; }

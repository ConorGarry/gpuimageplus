...
//	extern CGEConstString g_fshTest;
    ...
    public:
        ...
        virtual void render2Texture(CGEImageHandlerInterface *handler, GLuint srcTexture,
        ...
        virtual std::vector<CGEImageFilterInterface *>
        getFilters(bool bMove = true) { return std::vector<CGEImageFilterInterface *>(); }

...
Java_org_wysaid_nativePort_CGEImageFilter_createEnlarge2EyesFilter(JNIEnv *, jclass) {
...
JNIEXPORT jlong JNICALL
Java_org_wysaid_nativePort_CGEImageFilter_createEnlarge2EyesAndMouthFilter(JNIEnv *, jclass) {
...
Java_org_wysaid_nativePort_CGEImageFilter_setEnlarge2EyesFilterArgs(JNIEnv *, jclass, jlong addr,
                                                                    jfloat leftEyeRadius,
                                                                    jfloat rightEyeRadius,
                                                                    jfloat leftEyePosX,
                                                                    jfloat leftEyePosY,
                                                                    jfloat rightEyePosX,
                                                                    jfloat rightEyePosY) {
...
JNIEXPORT void JNICALL
Java_org_wysaid_nativePort_CGEImageFilter_setEnlarge2EyesFilterIntensity(JNIEnv *, jclass,
                                                                         jlong addr,
                                                                         jfloat intensity) {
    CGEEnlarge2EyesFilter *filter = (CGEEnlarge2EyesFilter *) addr;
...
JNIEXPORT void JNICALL
Java_org_wysaid_nativePort_CGEImageFilter_setEnlarge2EyesAndMouthFilterArgs(JNIEnv *, jclass,
                                                                            jlong addr,
                                                                            jfloat mouthRadius,
                                                                            jfloat mouthPosX,
                                                                            jfloat mouthPosY) {
...
JNIEXPORT jlong JNICALL
Java_org_wysaid_nativePort_CGEImageFilter_createAlienLookFilter(JNIEnv *, jclass) {
    auto *filter = createAlienLookFilter();
    return (jlong) filter;
}

JNIEXPORT void JNICALL
Java_org_wysaid_nativePort_CGEImageFilter_setAlienLookFilterArgs(JNIEnv *, jclass, jlong addr,
...
JNIEXPORT void JNICALL
Java_org_wysaid_nativePort_CGEImageFilter_setAlienLookFilterPosition(JNIEnv *, jclass, jlong addr,
                                                                     jfloat leftEyePosX,
                                                                     jfloat leftEyePosY,
                                                                     jfloat rightEyePosX,
                                                                     jfloat rightEyePosY,
                                                                     ...
                                                                     jfloat mouthPosY) {
    auto *filter = (CGEAlienLookFilter *) addr;
    filter->updateKeyPoints(leftEyePosX, leftEyePosY, rightEyePosX, rightEyePosY, mouthPosX,
                            mouthPosY);
}

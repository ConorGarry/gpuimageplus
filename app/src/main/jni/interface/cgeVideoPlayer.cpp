...
namespace CGE {
    CGEVideoPlayerYUV420P::CGEVideoPlayerYUV420P() : m_posAttribLocation(0),
                                                     m_decodeHandler(nullptr), m_vertexBuffer(0) {
        m_program.bindAttribLocation(CGEImageFilterInterface::paramPositionIndexName,
                                     m_posAttribLocation);

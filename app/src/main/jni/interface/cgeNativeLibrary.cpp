...
Java_org_wysaid_nativePort_CGENativeLibrary_cgeFilterImage_1MultipleEffects(JNIEnv *env, jclass cls,
                                                                            jobject bmp,
                                                                            jstring config,
                                                                            jfloat intensity) {
...

    {
        ...
        filter->initWithEffectString(nullptr, strConfig);
    ...
    CGE_LOG_INFO("unlocked pixels, function totalTime: %g s",
...
Java_org_wysaid_nativePort_CGENativeLibrary_cgeFilterImage_1MultipleEffectsWriteBack(JNIEnv *env,
                                                                                     jclass cls,
                                                                                     jobject bmp,
                                                                                     jstring config,
                                                                                     jfloat intensity) {
...
Java_org_wysaid_nativePort_CGENativeLibrary_cgeCreateFilterWithConfig(JNIEnv *env, jclass,
                                                                      jstring config) {
    static CGETexLoadArg texLoadArg;
    texLoadArg.env = env;
...
JNIEXPORT void JNICALL
Java_org_wysaid_nativePort_CGENativeLibrary_cgeDeleteFilterWithAddress(JNIEnv *env, jclass,
                                                                       jlong addr) {

...
namespace CGE {
    ...
    public:
        ...
        void setFilterWithConfig(CGEConstString config, CGETextureLoadFun texLoadFunc,
                                 jboolean shouldClearOlder, void *loadArg);

        void setFilterIntensity(int progress);

        void setFilterValueAtIndex(JNIEnv *env, const char *value, int index);

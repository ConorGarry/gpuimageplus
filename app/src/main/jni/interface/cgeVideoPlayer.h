...
namespace CGE {
    ...
    public:
        ...
        virtual bool open(const char *filename,
                          CGEVideoDecodeHandler::SamplingStyle s = CGEVideoDecodeHandler::ssFastBilinear) { return false; }
    ...
    public:
        ...
        bool open(const char *filename,
                  CGEVideoDecodeHandler::SamplingStyle s = CGEVideoDecodeHandler::ssFastBilinear);

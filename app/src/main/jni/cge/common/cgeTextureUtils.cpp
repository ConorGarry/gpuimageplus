...
static CGEConstString s_fshExternal_OES = "#extension GL_OES_EGL_image_external : require\n" CGE_SHADER_STRING_PRECISION_M (
        varying
        vec2 texCoord;
        uniform
        samplerExternalOES inputImageTexture;
        ...
        void main(void) {
            ...
            if (texCoord.y < 0.25) {
                ...
                posStep = 1.0;
                       ...
                       (texCoord.y == uMaxPos.y && texCoord.x < uMaxPos.x)) {
                ...
                posStep = 2.0;
                       ...
                       (texCoord.y == vMaxPos.y && texCoord.x < vMaxPos.x)) {
...
CGEConstString s_fshRGB2NV21 = CGE_SHADER_STRING_PRECISION_H (
        ...
        void main(void) {
            ...
            vec2
            uvPosOffset = vec2(uvlines - uvlinesI, uvlinesI / imageSize.y),
            imageStep = 1.0 / imageSize;
